...
public class AboutPanel extends JPanel {
    ...
    public AboutPanel() {
        ...
        gameTitleLabel.setFont(RMain.uiTextBig);
        ...
        creatorLabel.setFont(RMain.uiTextSmall);
