...
public class TutorialPanel extends JPanel {
    ...
    public TutorialPanel() {
        ...
        JLabel startBlockImageLabel = createTextImageLabel("Start Block", TrackBlock.startBlock, RMain.uiTextSmallItalics);
        JLabel checkpointBlockImageLabel = createTextImageLabel("Checkpoint Block", TrackBlock.checkpointBlock, RMain.uiTextSmallItalics);
        JLabel finishBlockImageLabel = createTextImageLabel("Finish Block", TrackBlock.finishBlock, RMain.uiTextSmallItalics);
        JLabel boostBlockImageLabel = createTextImageLabel("Boost Block", TrackBlock.boostBlock, RMain.uiTextSmallItalics);
        JLabel noControlImageBlock = createTextImageLabel("No Control Block", TrackBlock.nocontrolBlock, RMain.uiTextSmallItalics);
        JLabel resetBlockImageLabel = createTextImageLabel("Reset Block", TrackBlock.resetBlock, RMain.uiTextSmallItalics);
        ...
        // Controls
        JLabel controlsLabel = createLeftAlignedLabel("Controls", RMain.uiTextMedium);
        JLabel forwardsLabel = createLeftAlignedLabel("W - Forwards", RMain.uiTextTiny);
        JLabel leftLabel = createLeftAlignedLabel("A - Turn Left", RMain.uiTextTiny);
        JLabel rightLabel = createLeftAlignedLabel("D - Turn Right", RMain.uiTextTiny);
        JLabel brakeLabel = createLeftAlignedLabel("LShift - Brake", RMain.uiTextTiny);
        JLabel resetLabel = createLeftAlignedLabel("Backspace - Reset to Start", RMain.uiTextTiny);
        JLabel respawnLabel = createLeftAlignedLabel("Enter - Respawn at Last Checkpoint", RMain.uiTextTiny);

        // How to play
        JLabel howToPlayLabel = createLeftAlignedLabel("How to Play", RMain.uiTextMedium);
        JLabel descriptionLabel1 = createLeftAlignedLabel("Play as many tracks as you can, finish as fast as possible, and gather as many medals as possible!", RMain.uiTextTiny);
        JLabel descriptionLabel2 = createLeftAlignedLabel("Each track has four medal times to beat: bronze, silver, gold, and author, each of which provide", RMain.uiTextTiny);
        JLabel descriptionLabel3 = createLeftAlignedLabel("a new challenge and endless replayability!", RMain.uiTextTiny);
        JLabel descriptionLabel4 = createLeftAlignedLabel("Time elapsed and checkpoints are shown in the bottom middle, with speed in the bottom right.", RMain.uiTextTiny);

        // Block descriptions
        JLabel blockLabel = createLeftAlignedLabel("Track Blocks", RMain.uiTextMedium);
        JLabel blockPrefaceLabel = createLeftAlignedLabel("Each track is composed of blocks, which all have different behaviour:", RMain.uiTextTiny);
        JLabel startBlockDescriptionLabel = createLeftAlignedLabel("    - Start Block: Where your rocket starts the level", RMain.uiTextTiny);
        JLabel checkpointBlockDescriptionLabel = createLeftAlignedLabel("    - Checkpoint block: Go through all of these to finish a level", RMain.uiTextTiny);
        JLabel finishBlockDescriptionLabel = createLeftAlignedLabel("    - Finish block: End here after reaching all checkpoints", RMain.uiTextTiny);
        JLabel boostBlockDescriptionLabel = createLeftAlignedLabel("    - Boost block: Increases the acceleration of your rocket until the next reset block", RMain.uiTextTiny);
        JLabel nocontrolBlockDescriptionLabel = createLeftAlignedLabel("    - No control block: Disables control of your rocket until the next reset block", RMain.uiTextTiny);
        JLabel resetBlockDescriptionLabel = createLeftAlignedLabel("    - Reset block: Resets you to your original state", RMain.uiTextTiny);
