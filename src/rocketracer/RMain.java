...
public class RMain {
	...
	public static ImageIcon gameIcon = new ImageIcon("assets/img/game_icon.png");
	public static Image gameIconImage = gameIcon.getImage();
	...
	// Fonts
	public static Font uiTextBig = new Font(Font.SANS_SERIF, Font.BOLD, 64);
	public static Font uiTextBigItalics = new Font(Font.SANS_SERIF, Font.BOLD | Font.ITALIC, 64);
	public static Font uiTextMediumHighlight = new Font(Font.SANS_SERIF, Font.ITALIC | Font.BOLD, 48);
	public static Font uiTextMedium = new Font(Font.SANS_SERIF, Font.BOLD, 48);
	public static Font uiTextSmall = new Font(Font.SANS_SERIF, Font.PLAIN, 40);
	public static Font uiTextSmallItalics = new Font(Font.SANS_SERIF, Font.ITALIC, 40);
	public static Font uiTextSmallBold = new Font(Font.SANS_SERIF, Font.BOLD, 40);
	public static Font uiTextTiny = new Font(Font.SANS_SERIF, Font.PLAIN, 24);
	public static Font uiTextTinyItalics = new Font(Font.SANS_SERIF, Font.ITALIC, 24);
	
	// Button border
	public static Border buttonBorder = BorderFactory.createCompoundBorder(BorderFactory.createLineBorder(Color.WHITE, 5), BorderFactory.createEmptyBorder(2, 15, 2, 15));
	 ...
	 * 
	 * @param trackID
	 *            The ID of the track to add a personal best for
	 * @param time
	 *            the time achieved
	 */
